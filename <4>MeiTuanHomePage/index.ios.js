      ...
      <View style={{}}>
          <View style={[styles.height160, styles.row]}>
              <View style={[styles.height160, styles.part_1_left]}>
                  ...
                  <Text style={[styles.font10, styles.marTop14, styles.marLeft10]}>恋人家人好朋友</Text>
              ...
              <View style={[styles.height160, styles.part_1_right]}>
                  ...
                  <View style={[{flex: 1}, {marginTop: -13}]}>
                      <Image style={[styles.hanbao]} source={{rui: 'http://p0.meituan.net/mmc/a06d0c5c0a972e784345b2d648b034ec9710.jpg'}}></Image>
                  </View>
